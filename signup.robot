...
Deve poder cadastrar um novo dog walker 
    ${name}                Set Variable    Raquel Mendes 
    ${email}               Set Variable    raquelmg88@gmail.com
    ${cpf}                 Set Variable    45565981093
    ${cep}                 Set Variable    08020010
    ${addressStreet}       Set Variable    Rua Torixoréu  
    ${addressDistrict}     Set Variable    Parque Sonia 
    ${addressCityUf}       Set Variable    São Paulo/SP
    ${addressNumber}       Set Variable    1000
    ${addressDetails}      Set Variable    Apto    108 
    ${cnh}                 Set Variable    CNH.jpg
